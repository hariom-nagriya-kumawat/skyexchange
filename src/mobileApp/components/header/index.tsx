    ...
    return (
        <header>
            ...
            <div className="btn-wrap">
                <a className="btn-signup ui-link" onClick={() => window.open('https://wa.link/skyfair', '_blank')}>Sign up</a>

                <a className="login-index ui-link" href="#" onClick={() => { }}>Login</a>
            </div>
            ...
            {/* <div id="msgBox" className="message-wrap success to-open_bets" style="display: none;">
                <div className="message">
                    ...
                    <p id="info">
                        ...
                        <strong id="stake">$1,000</strong> at odds <strong id="odds">1.29</strong>
                    </p>
                </div>
                ...
                <div className="wallet-detail">
                    ...
                    <div id="walletTemp" className="wallet-detail-group" style="display: none;">
                        <dl id="tempDl" className="wallet-detail-content">
                            ...
                            <dd className="wallet-balance-num">
                                <span className="badge-currency" id="vendorCurrency">USD</span>
